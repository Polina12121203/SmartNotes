...
class Widget(QMainWindow):
    ...
    def save_note(self):
        if self.ui.listWidget.selectedItems():
            ...
            self.ui.listWidget_2.addItems(self.notes[key][''])
